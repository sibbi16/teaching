...
<section class="course-details-area pt-120" style="margin-bottom:30px">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 left-contents">
                <div class="main-image">
                    <img class="img-fluid" width="100%" src="img/word.png" alt="">
                </div>
                <div class="jq-tab-wrapper" id="horizontalTab">
                    <div class="jq-tab-menu">
                        ...
                        <!-- <div class="jq-tab-tigtle" data-tab="5">Reviews</div> -->
                    </div>
                    <div class="jq-tab-content-wrapper pb-5">
                        <div class="jq-tab-content active" data-tab="1">
                            Starting out in Microsoft Word or need a refresher? This online course is designed to give you a solid foundation in MS Word.
                            In this course, you will learn how to format text with fonts and colors, use bullets and indents, customize the Quick Access Toolbar, insert pictures and screenshots, set up page layout for margins and printing and much more.
                            ...
                            Video tutorials are recorded for Microsoft 365 (previously known as Office 365), Word 2019, 2016 and 2013 for PC.
                        </div>
